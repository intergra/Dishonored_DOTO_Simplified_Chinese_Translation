...
**面向中国大陆玩家的高质量简体中文本地化，覆盖菜单、界面、任务、书信、日志、对白字幕与中文字体。**
...
`v1.0` 完整包已经通过离线构建、独立回读和首次安装沙箱验证，但 DOTO 专属译文仍在
逐条精审，普通玩家流程的实机验收也尚未完成。两项工作都通过后，正式安装包才会发布到
本仓库的 [Releases](https://github.com/intergra/Dishonored_DOTO_Simplified_Chinese_Translation/releases)
页面，文件名固定为：
...
项目已经复用《耻辱2》中英文原文完全一致且完成审校的共有译文。DOTO 新增文本目前仍
保留可独立修改的初始审校种子，不能提前称为全部完成精校：
...
- 当前正式 Release 尚未发布，DOTO 专属译文的精审进度和实机验收结果以本页顶部状态
  为准。
